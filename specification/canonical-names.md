...
This page defines the canonical semantic names used by CAP `v0.3.0`.
...
The canonical-name registry covers these vocabulary families:
...
Use it when the server supports statistically validated observational semantics as defined by this specification.
...
`3` is reserved for the Counterfact tier in this version.

Servers MUST NOT declare `conformance_level: 3` until CAP activates Level 3 normatively.
